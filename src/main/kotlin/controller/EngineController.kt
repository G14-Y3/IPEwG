...
class EngineController : Controller() {
    ...
    fun CNNVisualize(netName: String, layerNum: Int, channelNum: List<Int>, height: Int, width: Int) = engine.transform(CNNVisualization(netName, layerNum, channelNum, height, width))
